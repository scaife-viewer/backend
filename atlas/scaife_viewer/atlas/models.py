...
class TextAlignmentRecord(models.Model):
    ...
    #     "scaife_viewer_atlas.Node", related_name="text_alignment_chunks", on_delete=models.CASCADE
    # )
    ...
    # )
    # end = models.ForeignKey("scaife_viewer_atlas.Node", related_name="+", on_delete=models.CASCADE)
